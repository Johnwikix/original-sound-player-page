...
export const faqData: FaqItem[] = [
  ...
  },
  {
    ...
    links: [
      { label: 'Segoe Fluent Icons', labelEn: 'Segoe Fluent Icons', url: 'https://aka.ms/SegoeFluentIcons' },
  ...
  },
  {
    ...
    links: [{ label: 'rg-adguard.net', labelEn: 'rg-adguard.net', url: 'https://store.rg-adguard.net' }]
  },
  {
    id: 4,
    question: '亚克力效果没有生效？',
  ...
  },
  {
    ...
    steps: [
      '可通过邮箱 dannypan9709@foxmail.com 反馈问题或建议。'
    ],
    stepsEn: [
      'Send feedback or suggestions to dannypan9709@foxmail.com.'
    ],
    links: [
      { label: '邮件联系', labelEn: 'Contact via Email', url: 'mailto:dannypan9709@foxmail.com' }
    ]
