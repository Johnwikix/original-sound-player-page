<template>
    <a-layout class="app-layout">
                ...
                <a-row :gutter="[32, 32]" justify="center">
                    ...
                    <a-col :xs="24" :md="12" :lg="8">
                        <a-card class="feature-card">
                            ...
                            <a-typography-paragraph class="feature-card-content">
                                自动扫描并管理你的本地音乐文件。轻松按专辑、艺术家或文件夹浏览，还能进行元数据编辑，自动匹配歌词和歌曲封面。
                            </a-typography-paragraph>
                            <div class="feature-image-wrapper">
                    ...
                    <a-col :xs="24" :md="12" :lg="8">
                        <a-card class="feature-card">
                            ...
                            <a-typography-paragraph class="feature-card-content">
                                支持包括flac,wav,mp3,dsf,ape,m4a,wmv,aiff,oga等多种音频格式，搭配均衡器和wasapi独占模式，还原音乐最本真的细节。
                            </a-typography-paragraph>
                            <div class="feature-image-wrapper">
        ...
        <a-layout-footer class="footer">
            © 2025 Sennpei Studio All Rights Reserved.
        </a-layout-footer>
    </a-layout>
</template>
